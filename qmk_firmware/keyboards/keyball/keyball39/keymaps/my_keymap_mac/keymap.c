...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    RCTL_T(KC_A), KC_S  , LSFT_T(KC_D)     , KC_F     , KC_G     ,                            KC_H     , KC_J     , KC_K     , KC_L     , KC_COLN  ,
    KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     ,                            KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  ,
    MO(3)    , KC_RCTL  , KC_ROPT  , KC_RSFT  , LT(2,KC_SPC),KC_RCMD,        KC_BSPC,LT(1,KC_ENT),XXXXXXX,XXXXXXX,XXXXXXX, KC_ESC
  ),
